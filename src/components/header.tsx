    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center justify-between">
        ...
        <div className="flex items-center gap-2">
            <Button asChild className="hidden md:flex bg-green-500 hover:bg-green-600 text-white" size="sm">
                        ...
                        <div className="mt-6 flex flex-col gap-4">
                            <Button asChild className="w-full">
                             ...
                             <Button asChild className="w-full bg-green-500 hover:bg-green-600 text-white">
                                <a href="https://wa.me/911234567890" target="_blank" rel="noopener noreferrer" onClick={() => setIsOpen(false)}>
                                    <WhatsAppIcon />
                                    WhatsApp
                                </a>
                            </Button>
                             <Button asChild className="w-full" variant="outline">
                                <a href="tel:+911234567890" onClick={() => setIsOpen(false)}>
                                    <Phone />
                                    Call Us
                                </a>
                            </Button>
